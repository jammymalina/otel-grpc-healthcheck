...
dist:
  ...
  output_path: ./bin
  otelcol_version: 0.142.0

exporters:
  - gomod: go.opentelemetry.io/collector/exporter/debugexporter v0.142.0

extensions:
  - gomod: github.com/open-telemetry/opentelemetry-collector-contrib/extension/healthcheckextension v0.142.0 # Required
  - gomod: github.com/jammymalina/otel-grpc-healthcheck v0.142.0
