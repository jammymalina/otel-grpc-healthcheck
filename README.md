...
extensions:
  - gomod: github.com/open-telemetry/opentelemetry-collector-contrib/extension/healthcheckextension v0.143.0 # Required
  - gomod: github.com/jammymalina/otel-grpc-healthcheck v0.143.0
...
providers:
  ...
  - gomod: go.opentelemetry.io/collector/confmap/provider/httpsprovider v1.49.0
