...
dist:
  ...
  output_path: ./bin
  otelcol_version: 0.145.0

exporters:
  - gomod: go.opentelemetry.io/collector/exporter/debugexporter v0.145.0

extensions:
  - gomod: github.com/open-telemetry/opentelemetry-collector-contrib/extension/healthcheckextension v0.145.0 # Required
  - gomod: github.com/jammymalina/otel-grpc-healthcheck v0.145.0
